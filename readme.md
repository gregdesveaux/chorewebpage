...
- **SMS** (`sms.*`): Optional Twilio credentials. Set `sms.enabled=true` and supply `TWILIO_ACCOUNT_SID`, `TWILIO_AUTH_TOKEN`, and a `TWILIO_FROM_NUMBER` to enable texts.
